    ...
    <div className="py-12 bg-gray-900">
        <div>
            <div className="text-center">
                <h2 className="text-base text-teal-600 font-semibold tracking-wide">Featured Couses</h2>
                <p className="mt-2 text-3xl leading-8 font-extrabold sm:text-4xl tracking-tight text-white">Learn with the Best</p>
            </div>
        </div>
        <div className="mt-10">
